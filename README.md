...
### Use Case
A simple collection view, with paging enabled, in which the size of each cell is equal to collection view's bounds with a single ASTextNode in the center. On rotation the cell size changes to use the updated width and height
